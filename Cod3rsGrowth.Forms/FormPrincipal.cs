    ...
    public partial class FormularioPrincipal : Form
    {
        ...
        private void AoClicarEmEditarAbreFormularioEditarHabilidade(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    MessageBox.Show("A tabela habilidades est� vazia.", tituloJanela, MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }
            catch (Exception)
            {
        ...
        private void AoClicarEmRemoverExcluiPersonagem(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    MessageBox.Show("A tabela personagens est� vazia.", tituloJanela, MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }
            catch (Exception)
            {
